...
export const CATALOGO_LOJA: ItemLoja[] = [
  ...
  {
    id: "tema-preto-premium",
    tipo: "tema",
    nome: "Preto Premium",
    descricao: "Interface quase preta, contraste alto e acabamento prateado.",
    preco: 220,
    raridade: "raro",
    icone: "⚫",
    valorVisual: "preto-premium",
  },
  {
    id: "tema-grafite",
    tipo: "tema",
    nome: "Grafite",
    descricao: "Cinza grafite profundo com cartões neutros e visual discreto.",
    preco: 180,
    raridade: "comum",
    icone: "◼️",
    valorVisual: "grafite",
  },
  {
    ...
    tipo: "tema",
    nome: "Carbono",
    descricao: "Preto técnico com contraste de aço e aparência mais esportiva.",
    preco: 290,
    raridade: "epico",
    icone: "⬛",
    valorVisual: "carbono",
  },
  {
    ...
    tipo: "tema",
    nome: "Ardósia",
    descricao: "Cinza azulado fechado para quem prefere um tema escuro mais suave.",
    preco: 250,
    raridade: "raro",
    icone: "🌑",
    valorVisual: "ardosia",
  },
  /* Temas antigos ficam preservados para quem já comprou, mas saem das novas vendas. */
  {
  ...
  },
  {
    ...
    tipo: "tema",
    nome: "Dourado Elite",
    descricao: "Tema legado preservado apenas para quem já o adquiriu.",
    preco: 330,
    raridade: "epico",
    icone: "🟡",
